document.onload = function() {
    ...
    if(mql.matches) {
        ...
        cocktail_certificate_exam3();
    }
};


// 1차 시험 내용
function cocktail_certificate_exam1() {
...
// 2차 시험 내용
function cocktail_certificate_exam2() {
...
// 3차 시험 내용
function cocktail_certificate_exam3() {
    document.getElementById('test1').classList.remove('active');
    document.getElementById('test2').classList.remove('active');
...
// 4차 시험 내용
function cocktail_certificate_exam4() {
    document.getElementById('test1').classList.remove('active');
    document.getElementById('test2').classList.remove('active');
    document.getElementById('test3').classList.remove('active');
